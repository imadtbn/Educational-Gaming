...
export type BadgeId = "first-steps" | "animal-scout" | "animal-wordsmith" | "animal-english-ace" | "number-ninja" | "math-explorer" | "math-reviser" | "writing-trail" | "card-collector" | "story-explorer";
...
export const BADGES: Record<BadgeId, { title: string; icon: string; color: string }> = {
  ...
  "story-explorer": { title: "قارئ الحكايات", icon: "☼", color: "teal" },
};
